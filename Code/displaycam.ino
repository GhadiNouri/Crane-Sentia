...
#define F_CPU 16000000UL //cpu clock frequency = 16MHz
#define vga   0 //video graphic array
#define qvga  1 //quarter video graphic array
#define qqvga   2 //quarter-quarter cideo graphic array
#define yuv422  0 //  color format
#define rgb565  1 //color format
#define bayerRGB  2 //color format
#define camAddr_WR  0x42 //in decimal 66 => write camera operations
#define camAddr_RD  0x43 // in decimal 67 => read camera operations
